...
## Исправления от 30.05.2026

Исправлены дедлоки на затяжном использовании из-за использования многочисленных независимых мьютексов. Переписал всю синхронизацию использую семафоры и QRecursiveMutex. Писал вслепую, потому что, по не зависящим от меня обстоятельствам, брокерского счёта не имею и протестировать не могу. Но люди тестировали и подтвердили, что проблема исправлена и всё работает.